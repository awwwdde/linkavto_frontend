...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: 'favorites', lazy: () => import('@/pages/favorites') },
      {
        ...
        children: [
          { index: true, lazy: () => import('@/pages/profile/hub') },
          ...
          { path: 'messages', lazy: () => import('@/pages/profile/messages') },
          { path: 'reviews', lazy: () => import('@/pages/profile/my-reviews') },
          { path: 'questions', lazy: () => import('@/pages/profile/my-questions') },
        ],
      },
